...
| POST   | `/api/Rpayment/order`           | Create a Razorpay order              |
| POST   | `/api/Rpayment/subscription`    | Create a Razorpay subscription       |
| POST   | `/api/Rpayment/verify`          | Verify a Razorpay payment            |
